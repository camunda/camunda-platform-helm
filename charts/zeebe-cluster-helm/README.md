...
| `global.elasticsearch.host`         | ElasticSearch host do use in Elasticsearch Exporter connection  | `elasticsearch-master` |
| `global.elasticsearch.port`         | ElasticSearch port do use in Elasticsearch Exporter connection | `9200` |
| `global.elasticsearch.url`         | ElasticSearch full url do use in Elasticsearch Exporter connection. This config overrides the `host` and `port` above.  |  |
