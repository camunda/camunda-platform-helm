...
|              | `image.tag`                          | Can be set to overwrite the global tag, which should be used in that chart                                                                                                                                                                        | `Check the values file`                                                                               |
|              | `image.pullSecrets`                  | Can be set to overwrite the global.image.pullSecrets  <br/>                                                                                                                                                                                       | `{{ global.image.pullSecrets }}`                                                                      |
|              | `initContainers`                     | Use this to initialize a Pod before an application Container runs.                                                                                                                                                                                | `[]`                                                                                                  |
|              | `sidecars`                           | Can be used to deploy extra containers in the same pod                                                                                                                                                                                            | `[]`                                                                                                  |
