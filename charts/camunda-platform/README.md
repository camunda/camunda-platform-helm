...
| | `identity.keycloak.legacy` |    Identity.keycloak.legacy if true, it will configure Keycloak service name according to Keycloak v16. If false, then it will configure Keycloak service name according to Keycloak v19. This config is used when Keycloak v19 Helm chart is used. Note: This is just for config, it will not enable Keycloak v19). | `""` |
