...
# Called by deploy-camunda's PreInstallHook mechanism before the companion
# postgresql chart and the main Camunda chart are installed.
#
...
exec bash "${SCRIPT_DIR}/create-rdbms-tls-secrets.sh"
