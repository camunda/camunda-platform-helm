...
func (s *RestapiResourcesCPUTemplateTest) TestCPUResourcesAsString() {
	...
	options := &helm.Options{
		SetValues: map[string]string{
			...
			"camundaHub.restapi.resources.requests.memory": "256Mi",
			"camundaHub.restapi.resources.limits.memory":   "512Mi",
		},
...
func (s *RestapiResourcesCPUTemplateTest) TestCPUResourcesCustomValues() {
	...
	options := &helm.Options{
		SetValues: map[string]string{
			...
			"camundaHub.restapi.resources.requests.memory": "1Gi",
			"camundaHub.restapi.resources.limits.memory":   "2Gi",
		},
		KubectlOptions: k8s.NewKubectlOptions("", "", s.namespace),
	}
