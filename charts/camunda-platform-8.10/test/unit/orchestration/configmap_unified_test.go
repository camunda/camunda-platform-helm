	...
	testCases := []testhelpers.TestCase{
		...
		},
		{
			...
			Values: map[string]string{
				...
				"orchestration.hub.ping.credentials.audience":                         "https://hub.example/api",
				"orchestration.hub.ping.credentials.scope":                            "api://hub/.default",
			...
			Expected: map[string]string{
				...
				"configmapApplication.camunda.hub.ping.credentials.audience":       "https://hub.example/api",
				"configmapApplication.camunda.hub.ping.credentials.scope":          "api://hub/.default",
			},
		},
		{
