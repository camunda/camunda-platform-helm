...
{{- .Values.orchestration.exporters.zeebe.index.prefix | default .Values.optimize.database.elasticsearch.prefix | default "zeebe-record" -}}
{{- end -}}
...
{{- .Values.orchestration.exporters.zeebe.index.prefix | default .Values.optimize.database.opensearch.prefix | default "zeebe-record" -}}
{{- end -}}
