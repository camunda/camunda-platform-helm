...
## [camunda-platform-13.0.0-alpha3](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-13.0.0-alpha3) (2025-03-28)

### Features

- Added connectors headless svc to alpha charts (#3244)
- Support setting upload request body size (#3248)
...
- docker.io/camunda/connectors-bundle:8.8.0-alpha3-rc1
