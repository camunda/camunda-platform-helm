...
## [camunda-platform-8.9-14.10.0](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-8.9-14.10.0) (2026-09-07)
...
```shell
cosign verify-blob camunda-platform-14.10.0.tgz \
  --bundle "camunda-platform-14.10.0-cosign-bundle.json" \
  --certificate-identity-regexp "https://github.com/camunda/camunda-platform-helm" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

For detailed verification instructions, check the steps in the `camunda-platform-14.10.0-cosign-verify.sh` file.
