...
## [camunda-platform-8.9-14.8.2](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-8.9-14.8.2) (2026-08-12)

### Fixes

- Document defaultRoles.admin.clients in orchestration values schema [ready] (#6560)
- Gate 8.9 OpenSearch password env vars on active consumers (#6774)
...
```shell
cosign verify-blob camunda-platform-14.8.2.tgz \
  --bundle "camunda-platform-14.8.2-cosign-bundle.json" \
  --certificate-identity-regexp "https://github.com/camunda/camunda-platform-helm" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

For detailed verification instructions, check the steps in the `camunda-platform-14.8.2-cosign-verify.sh` file.
