...
## [camunda-platform-8.9-14.8.5](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-8.9-14.8.5) (2026-08-24)
...
```shell
cosign verify-blob camunda-platform-14.8.5.tgz \
  --bundle "camunda-platform-14.8.5-cosign-bundle.json" \
  --certificate-identity-regexp "https://github.com/camunda/camunda-platform-helm" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

For detailed verification instructions, check the steps in the `camunda-platform-14.8.5-cosign-verify.sh` file.
