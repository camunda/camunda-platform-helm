...
## [camunda-platform-14.1.0-alpha1](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-14.1.0-alpha1) (2025-12-05)
...
```shell
cosign verify-blob camunda-platform-14.1.0-alpha1.tgz \
  --bundle "camunda-platform-14.1.0-alpha1-cosign-bundle.json" \
  --certificate-identity-regex "https://github.com/camunda/camunda-platform-helm" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

For detailed verification instructions, check the steps in the `camunda-platform-14.1.0-alpha1-cosign-verify.sh` file.
