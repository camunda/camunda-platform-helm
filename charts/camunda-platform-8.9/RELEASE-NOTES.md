...
## [camunda-platform-8.9-14.6.1](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-8.9-14.6.1) (2026-07-08)
...
```shell
cosign verify-blob camunda-platform-14.6.1.tgz \
  --bundle "camunda-platform-14.6.1-cosign-bundle.json" \
  --certificate-identity-regexp "https://github.com/camunda/camunda-platform-helm" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

For detailed verification instructions, check the steps in the `camunda-platform-14.6.1-cosign-verify.sh` file.
