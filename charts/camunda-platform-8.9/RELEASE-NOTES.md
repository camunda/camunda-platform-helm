...
## [camunda-platform-14.2.0](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-14.2.0) (2026-05-11)
...
```shell
cosign verify-blob camunda-platform-14.2.0.tgz \
  --bundle "camunda-platform-14.2.0-cosign-bundle.json" \
  --certificate-identity-regexp "https://github.com/camunda/camunda-platform-helm" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

For detailed verification instructions, check the steps in the `camunda-platform-14.2.0-cosign-verify.sh` file.
