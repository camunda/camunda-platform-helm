...
## [camunda-platform-8.7-12.13.1](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-8.7-12.13.1) (2026-07-08)

### Fixes

- Repair failing scheduled workflows for docs links, lychee, and values-latest (#6492)
...
```shell
cosign verify-blob camunda-platform-12.13.1.tgz \
  --bundle "camunda-platform-12.13.1-cosign-bundle.json" \
  --certificate-identity-regexp "https://github.com/camunda/camunda-platform-helm" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

For detailed verification instructions, check the steps in the `camunda-platform-12.13.1-cosign-verify.sh` file.
