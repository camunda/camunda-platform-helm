...
## [camunda-platform-12.8.6](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-12.8.6) (2026-04-22)
...
```shell
cosign verify-blob camunda-platform-12.8.6.tgz \
  --bundle "camunda-platform-12.8.6-cosign-bundle.json" \
  --certificate-identity-regexp "https://github.com/camunda/camunda-platform-helm" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

For detailed verification instructions, check the steps in the `camunda-platform-12.8.6-cosign-verify.sh` file.
