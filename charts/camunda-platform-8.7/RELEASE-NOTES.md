...
## [camunda-platform-8.7-12.13.5](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-8.7-12.13.5) (2026-09-08)
...
```shell
cosign verify-blob camunda-platform-12.13.5.tgz \
  --bundle "camunda-platform-12.13.5-cosign-bundle.json" \
  --certificate-identity-regexp "https://github.com/camunda/camunda-platform-helm" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

For detailed verification instructions, check the steps in the `camunda-platform-12.13.5-cosign-verify.sh` file.
