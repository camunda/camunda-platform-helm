...
## [camunda-platform-12.4.0](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-12.4.0) (2025-07-17)
...
- docker.io/camunda/connectors-bundle:8.7.6
- docker.io/camunda/console:8.7.46
- docker.io/camunda/identity:8.7.4
- docker.io/camunda/keycloak:26.1.4
- docker.io/camunda/operate:8.7.8
- docker.io/camunda/optimize:8.7.5
- docker.io/camunda/tasklist:8.7.8
