...
## [camunda-platform-13.10.0](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-13.10.0) (2026-05-29)

### Features

- Add orchestration.hostNetwork value (#6247)
...
```shell
cosign verify-blob camunda-platform-13.10.0.tgz \
  --bundle "camunda-platform-13.10.0-cosign-bundle.json" \
  --certificate-identity-regexp "https://github.com/camunda/camunda-platform-helm" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

For detailed verification instructions, check the steps in the `camunda-platform-13.10.0-cosign-verify.sh` file.
