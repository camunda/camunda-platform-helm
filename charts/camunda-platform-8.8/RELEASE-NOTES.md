...
```shell
cosign verify-blob camunda-platform-13.7.2.tgz \
  --bundle "camunda-platform-13.7.2-cosign-bundle.json" \
  --certificate-identity-regexp "https://github.com/camunda/camunda-platform-helm" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

For detailed verification instructions, check the steps in the `camunda-platform-13.7.2-cosign-verify.sh` file.
