...
## [camunda-platform-13.5.3](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-13.5.3) (2026-03-09)
...
- Migration from tibdex to github as recommended on the tibdex … (#5287)
...
```shell
cosign verify-blob camunda-platform-13.5.3.tgz \
  --bundle "camunda-platform-13.5.3-cosign-bundle.json" \
  --certificate-identity-regexp "https://github.com/camunda/camunda-platform-helm" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

For detailed verification instructions, check the steps in the `camunda-platform-13.5.3-cosign-verify.sh` file.
