...
## [camunda-platform-13.9.1](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-13.9.1) (2026-05-22)

### Fixes

- Hard-coded resources and limits in migration jobs (#6031)
...
```shell
cosign verify-blob camunda-platform-13.9.1.tgz \
  --bundle "camunda-platform-13.9.1-cosign-bundle.json" \
  --certificate-identity-regexp "https://github.com/camunda/camunda-platform-helm" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

For detailed verification instructions, check the steps in the `camunda-platform-13.9.1-cosign-verify.sh` file.
