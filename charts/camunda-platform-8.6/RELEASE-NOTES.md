...
## [camunda-platform-11.12.1](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-11.12.1) (2026-03-06)
...
```shell
cosign verify-blob camunda-platform-11.12.1.tgz \
  --bundle "camunda-platform-11.12.1-cosign-bundle.json" \
  --certificate-identity-regexp "https://github.com/camunda/camunda-platform-helm" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

For detailed verification instructions, check the steps in the `camunda-platform-11.12.1-cosign-verify.sh` file.
