...
func (c *DeploymentConfig) Validate() error {
	...
	validPersistence := []string{"elasticsearch", "elasticsearch-external", "elasticsearch-external-self-signed", "elasticsearch-self-signed", "no-elasticsearch", "opensearch", "opensearch-embedded", "opensearch-external", "opensearch-self-signed", "rdbms", "rdbms-external", "rdbms-oracle"}
