...
All diagnostic output goes to stderr via the logger.`,
	...
	f.StringVar(&pv.persistence, "persistence", "", "Persistence selection: elasticsearch, elasticsearch-external, elasticsearch-self-signed, elasticsearch-external-self-signed, opensearch, opensearch-embedded, opensearch-external, opensearch-self-signed-os-trust, rdbms, rdbms-oracle")
	...
	_ = cmd.RegisterFlagCompletionFunc("persistence", func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
		return []string{"elasticsearch", "elasticsearch-external", "elasticsearch-self-signed", "elasticsearch-external-self-signed", "opensearch", "opensearch-embedded", "opensearch-external", "opensearch-self-signed-os-trust", "rdbms", "rdbms-external", "rdbms-oracle"}, cobra.ShellCompDirectiveNoFileComp
	})
