...
func NewRootCommand() *cobra.Command {
	...
	f.StringVar(&flags.Selection.Persistence, "persistence", "", "Persistence selection: elasticsearch, elasticsearch-self-signed, elasticsearch-external-self-signed, opensearch, opensearch-embedded, opensearch-external, opensearch-self-signed, rdbms, rdbms-external, rdbms-oracle, rdbms-self-signed")
