...
func TestPlanTopologyWorkflowMetadata(t *testing.T) {
	...
	wantSmoke := `[{"orchestration_suffix":"orcha","modeler_cluster_id":"orcha","modeler_cluster_name":"Orchestration A","shard_index":"1","chart_version":"8.10","chart_dir":"camunda-platform-8.10","suite":"hub","test_chart_dir":"camunda-platform-8.10","playwright_project":"hub-web-modeler"},{"orchestration_suffix":"orcha","modeler_cluster_id":"orcha","shard_index":"2","chart_version":"8.10","chart_dir":"camunda-platform-8.10","suite":"orchestration","test_chart_dir":"camunda-platform-8.10","playwright_project":"topology-orchestration"},{"orchestration_suffix":"orchb","modeler_cluster_id":"orchb","modeler_cluster_name":"Orchestration B","shard_index":"3","chart_version":"8.9","chart_dir":"camunda-platform-8.9","suite":"hub","test_chart_dir":"camunda-platform-8.10","playwright_project":"hub-web-modeler"},{"orchestration_suffix":"orchb","modeler_cluster_id":"orchb","shard_index":"4","chart_version":"8.9","chart_dir":"camunda-platform-8.9","suite":"orchestration","test_chart_dir":"camunda-platform-8.9","playwright_project":"topology-orchestration"}]`
...
func TestPlanTopologyMetadataUsesReleaseChartVersion(t *testing.T) {
	...
	want := `[{"orchestration_suffix":"current","modeler_cluster_id":"current","modeler_cluster_name":"Current","shard_index":"1","chart_version":"8.10","chart_dir":"camunda-platform-8.10","suite":"hub","test_chart_dir":"camunda-platform-8.10","playwright_project":"hub-web-modeler"},{"orchestration_suffix":"current","modeler_cluster_id":"current","shard_index":"2","chart_version":"8.10","chart_dir":"camunda-platform-8.10","suite":"orchestration","test_chart_dir":"camunda-platform-8.10","playwright_project":"topology-orchestration"},{"orchestration_suffix":"previous","modeler_cluster_id":"previous","modeler_cluster_name":"Previous","shard_index":"3","chart_version":"8.9","chart_dir":"camunda-platform-8.9","suite":"hub","test_chart_dir":"camunda-platform-8.10","playwright_project":"hub-web-modeler"},{"orchestration_suffix":"previous","modeler_cluster_id":"previous","shard_index":"4","chart_version":"8.9","chart_dir":"camunda-platform-8.9","suite":"orchestration","test_chart_dir":"camunda-platform-8.9","playwright_project":"topology-orchestration"}]`
	if smoke != want {
