...
release.generate-pr-url:
	...
	@echo "https://github.com/camunda/camunda-platform-helm/compare/camunda-platform-8.4...release-v8.4?expand=1&template=release_template.md&title=Release%20Camunda%20Platform%20Helm%20Chart%20v$(chartVersion)&labels=camunda-platform,chore"
	@echo "\n###################################\n\n"

.PHONY: release.chores
release.chores:
	git checkout camunda-platform-8.4
	git pull --tags
	git switch -C release-v8.4
	@$(MAKE) release.bump-chart-version-and-commit
	@$(MAKE) release.generate-and-commit
	git push -fu origin release-v8.4
