...
release.generate-pr-url:
	...
	@echo "https://github.com/camunda/camunda-platform-helm/compare/camunda-platform-8.2...release?expand=1&template=release_template.md&title=Release%20Camunda%20Platform%20Helm%20Chart%20v$(chartVersion)&labels=camunda-platform,chore&projects=camunda/33"
	@echo "\n###################################\n\n"
